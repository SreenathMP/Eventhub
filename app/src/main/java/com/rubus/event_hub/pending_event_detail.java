...
import com.rubus.utils.SquareImageView;
...
public class pending_event_detail extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
       ...
       Button btn_approve=findViewById(R.id.btn_appove);
        ...
        bannerLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(pending_event_detail.this,LongImageActivity.class);
...
btn_approve.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        String status=postId + "/status";

        FirebaseDatabase.getInstance().getReference("eventhub/events")
                .child(status).setValue(true);

        Toast.makeText(pending_event_detail.this, "Event Approved Successfully", Toast.LENGTH_LONG).show();

        startActivity(new Intent(new Intent(pending_event_detail.this,pending_events.class)));
        finish();
