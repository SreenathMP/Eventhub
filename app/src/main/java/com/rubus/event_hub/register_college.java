...
public class register_college extends AppCompatActivity {
            ...
            public void onShow(final DialogInterface dialog) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(!department.getText().toString().equals("") && !phone.getText().toString().equals("") && phone.getText().length()==10) {
                            dialog.dismiss();
                            register_button.setEnabled(false);
                            register_button.setClickable(false);
                            register_user(department.getText().toString(),phone.getText().toString());
    ...
    protected void register_user(final String department,final String phone_number){
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(register_college.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(register_college.this, "Authentication failed." + task.getException(),
                            ...
                            user_college_profile users = new user_college_profile(
                                    name,
                                    college,
                                    email,
                                    department,
                            ...
                            user_type.put("account","college");

                            FirebaseDatabase.getInstance().getReference("eventhub/college_profiles")
                                    .child(uid)
                                    .setValue(users);
                            ...
                            Toast.makeText(register_college.this, "Registration Successfull",
                                    Toast.LENGTH_SHORT).show();
                            progressBar.setVisibility(View.GONE);
                            FirebaseAuth.getInstance().signOut();
                            startActivity(new Intent(register_college.this,login_college.class));
